...
//!
//! ```rust
//! use radicle_cli::terminal::ansi::{Paint, Color};
//!
//! println!("Testing, {}, {}, {}!",
//!     Paint::red(1),
...
//!
//! ```rust
//! use radicle_cli::terminal::ansi::Paint;
//! use radicle_cli::terminal::ansi::Color::Red;
//!
...
//!
//! ```rust
//! use radicle_cli::terminal::ansi::{Paint, Color, Style};
//!
